...
preguntas_normal = [
    ...
    Pregunta("¿Cuál es el país más grande del mundo?", ["China", "Rusia", "Estados Unidos", "Canadá"], 1, "normal", "multiple"),
]
...
preguntas_dificil = [
    ...
    Pregunta("¿Cuándo cayó el Imperio romano de Occidente?", ["476 d.C.", "744 a.C.", "23 d.C", "382 d.C."], 0, "dificil", "multiple"),
